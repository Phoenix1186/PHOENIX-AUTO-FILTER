...
# ⚠️ Please don't change our credits 👇🏻
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/ph0enix_web>𝙿𝙷𝙾𝙴𝙽𝙸𝚇</a>
✯ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂: <a href=https://t.me/ph0enix_web>𝙼𝙻𝚉_𝙱𝙾𝚃𝚉</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙺𝙾𝚈𝙴𝙱
...
<b>NOTE:</b>
<b>𝟷. PHOENIX 𝚂𝙷𝙾𝚄𝙻𝙳 𝙷𝙰𝚅𝙴 𝙰𝙳𝙼𝙸𝙽 𝙿𝚁𝙸𝚅𝙸𝙻𝙻𝙰𝙶𝙴.
...
𝟸. 𝙿𝙷𝙾𝙴𝙽𝙸𝚇 𝚂𝚄𝙿𝙿𝙾𝚁𝚃𝚂 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝚆𝙸𝚃𝙷 𝙰𝙽𝚈 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𝙼𝙴𝙳𝙸𝙰 𝚃𝚈𝙿𝙴.
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @ph0enix_web"""
    JSON_TXT = """<b>JSON:</b>
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ' : ( ! , . / )"""
    ...
    <code>[JOIN GROUP](buttonurl:https://t.me/ph0enix_web)</code>"""
