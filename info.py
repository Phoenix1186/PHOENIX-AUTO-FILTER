...
API_ID = int(environ.get('API_ID', '25157466'))
API_HASH = environ.get('API_HASH', '658a9b1f8cb368c2e57678231f517d4c')
BOT_TOKEN = environ.get('BOT_TOKEN', '8404793754:AAGTKZM2kGcJc_dPLKstGFznOWAoxb-NFzU')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6304040346').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://clonedatabase:clonedatabase@clonedatabase.hfmunxm.mongodb.net/?retryWrites=true&w=majority&appName=CLONEDATABASE")
...
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1002485054954').split()]
...
NO_RESULTS_CHANNEL = int(environ.get("NO_RESULTS_CHANNEL", "-1002450940556"))
...
S_GROUP = environ.get('S_GROUP',"https://t.me/mfilerequest")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/Phoenixmoviesfiles")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/Farmersbride")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺...')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002450940556'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mfilesupportgroup')
